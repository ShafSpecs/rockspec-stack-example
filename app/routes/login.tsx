...
export default function Login() {
  ...
  return (
    <div className="h-screen w-screen self-center relative flex flex-row content-center justify-center align-middle m-auto sm:pb-16 pt-6 sm:pt-8">
      <div className="mx-auto max-w-3xl w-full sm:min-w-[31rem] md:min-w-[36rem] md:max-w-2xl lg:min-w-[48rem] px-4 sm:px-6 lg:px-8 relative self-center">
        <div className="relative shadow-xl overflow-hidden py-3 sm:py-5 rounded-lg sm:rounded-2xl lg:py-7">
          ...
          <Form method="post" className="mb-2 py-2">
            <div>
            ...
            <div className="rounded-md shadow-sm -space-y-px px-8 pt-5 pb-2 md:px-12 md:pt-7 md:pb-4 lg:px-20 lg:py-10">
              <div>
